...
MAP = []
labels = []
tar_predicted_map_dir = "/home/wlsdzyzl/project/topohpm/generated_files/predictions/3d_asoca/UNET"
...
for tar_file in tar_file_list:
    # print(tar_file)
    map = load_itk(os.path.join(tar_predicted_map_dir, tar_file))[0][:,:,:, None]
...
trf_cfg = {'metric':'LEEP', 'num_category':1, 'stride':4 } 
...
np.save(os.path.join("resources/3DUnet_asoca/weight_map", 'imagecas_to_asoca_leep_unet.npy'), weight_map)
