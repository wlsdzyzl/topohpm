...
def main(argv):
    ...
    if len(opts) == 0:
        print('unknow options, usage: pmap2ply.py -i <inputfile> -o <outputfile> -p <prob_threshold = 0.5>')
        sys.exit()
    for opt, arg in opts:
        if opt in ('-h', '--help'):
            print('usage: pmap2ply.py -i <inputfile> -o <outputfile> -p <prob_threshold = 0.5>')
            sys.exit()
        elif opt in ("-i", '--input'):
            inputfile = arg
            ...
            print('unknow option, usage: pmap2ply.py -i <inputfile> -o <outputfile> -p <prob_threshold = 0.5>')
            sys.exit()
