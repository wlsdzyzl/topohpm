...
from topohpm.unet3d.buildingblocks import DoubleConv, ExtResNetBlock, create_encoders, \
    create_decoders
from topohpm.unet3d.utils import number_of_features_per_level, get_class
...
def get_model(model_config):
    model_class = get_class(model_config['name'], modules=['topohpm.unet3d.model'])
