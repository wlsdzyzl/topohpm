...
from toposeg.datasets.utils import get_test_loaders
from toposeg.unet3d.utils import get_logger, load_checkpoint
from toposeg.unet3d.config import load_config
...
def _get_predictor(model, output_dir, config, output_seg_dir = None, threshold = 0.5):
    ...
    m = importlib.import_module('toposeg.unet3d.predictor')
