...
from toposeg.unet3d.buildingblocks import DoubleConv, ExtResNetBlock, create_encoders, \
    create_decoders
from toposeg.unet3d.utils import number_of_features_per_level, get_class
...
def get_model(model_config):
    model_class = get_class(model_config['name'], modules=['toposeg.unet3d.model'])
