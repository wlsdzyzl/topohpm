...
from toposeg.unet3d.losses import compute_per_channel_dice
from toposeg.unet3d.seg_metrics import AveragePrecision, Accuracy
from toposeg.unet3d.utils import get_logger, expand_as_one_hot, convert_to_numpy
...
def get_evaluation_metric(config):
    ...
    def _metric_class(class_name):
        m = importlib.import_module('toposeg.unet3d.metrics')
