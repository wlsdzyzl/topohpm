...
if __name__ == "__main__":
    import time    
    for id in range(8):
        filename_data ='/home/*****/project/toposeg/generated_files/synthetic_dataset/val/data/' + str(id) + '.nii.gz'
        filename_label ='/home/*****/project/toposeg/generated_files/synthetic_dataset/val/label/' + str(id) + '.nii.gz'
